                        ...
                        <div class="container-fluid">
                            <div class="col-sm-6">
                                ...
                                <div class="register-left">
                                    ...
                                    <input type="password" id="pword" class=""><br>
                                    <label for="verify">Verify</label>
                                    <input type="password" id="verify" class="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <input type="file" name="fileToUpload" id="fileToUpload"><br>
                                <center>Quick Bio</center>
                                <textarea name="bio" class="registerbio" rows="4" form="usrform">Enter text here...</textarea>
                            </div>
                        </div>
